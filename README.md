...
Для удобства написания кода были добавлены подскази названий имён. Если правило нейминга нарушено, линтер может предложить корректное имя прямо в тексте диагностики:
